...
describe("ChatInterface", () => {
  ...
  it("hides tip buttons when multiple messages", () => {
    renderChatInterface({
      messages: [new AIMessage("Welcome"), new HumanMessage("Hi")],
    });
  ...
  it("disables Execute button when offline", () => {
    renderChatInterface({
      loading: false,
      conn: { ...defaultConn, status: "error", errorMessage: "fail" },
    });
  ...
  it("renders HumanMessage in user bubble", () => {
    renderChatInterface({
      messages: [new AIMessage("Welcome"), new HumanMessage("My question")],
    });
  ...
  it("filters out empty content messages", () => {
    const { container } = renderChatInterface({
      messages: [new AIMessage(""), new AIMessage("Visible")],
    });
